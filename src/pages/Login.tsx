      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground text-sm mt-1">
            {isRegister ? 'Join FreshCart for fresh deals' : 'Sign in to your FreshCart account'}
          </p>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full bg-secondary rounded-xl px-4 py-3 pr-10 text-sm outline-none focus:ring-2 focus:ring-primary/30 transition-shadow"
                placeholder="••••••••"
              />
